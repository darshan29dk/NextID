...
class RoleAttributeBase(BaseModel):
    attribute_name: str
    display_name: str
...
class RoleAttributeCreate(RoleAttributeBase):
...
class RoleAttributeResponse(RoleAttributeBase):
    id: int
    is_deleted: bool
    created_at: datetime
    updated_at: datetime
...
class RoleAttributePaginatedResponse(BaseModel):
    total: int
    page: int
    limit: int
    total_pages: int
...
class RoleAttributeUsageInfo(BaseModel):
    platform_roles_count: int = 0
    role_mining_count: int = 0
    role_catalog_count: int = 0
    birthright_roles_count: int = 0
    access_requests_count: int = 0
    access_certification_count: int = 0

class RoleAttributeDetailResponse(BaseModel):
    attribute: RoleAttributeResponse
    audit_history: List[AuditLogSchema]
    usage: Optional[RoleAttributeUsageInfo] = None
